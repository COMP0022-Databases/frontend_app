    ...
    return (
        <div className='text-white ' >
            <div className='max-w-[800px] mt-[96px] w-full h-screen mx-auto text-center flex flex-col '>
                ...
                <Link to="/search">
                    <button className='font-semibold transition ease-in-out delay-150 bg-fuchsia-300  hover:bg-sky-200 duration-300  opacity-80 my-6 mx-auto py-3 mt-8 w-[200px] rounded-md text-black drop-shadow-2xl'>Get Started</button>
                </Link>
            </div>
        </div>
    );
