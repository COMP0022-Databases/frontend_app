                ...
                <div>
                    <div className=" max-w-[1240px] mx-auto grid md:grid-cols-2 pb-80 pt-10">
                        <div className="text-white p-10">
                            ...
                            <Link to="/">
                                <button className=' ml-6 font-semibold transition ease-in-out delay-150 bg-fuchsia-300  hover:bg-sky-200 duration-300  opacity-80 my-6 mx-auto py-3 mt-8 w-[200px] rounded-md  text-black'>Go to home page.</button>
                            </Link>
                        </div>
                        <img
                            src="error.png"
                            class="flex-right mt-10 max-w p-10"
                            alt="..."
                        />
                    </div>
                </div>
